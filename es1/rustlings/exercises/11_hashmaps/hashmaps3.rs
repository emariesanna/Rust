...
fn build_scores_table(results: &str) -> HashMap<&str, TeamScores> {
    ...
    for line in results.lines() {
        ...
        scores.entry(team_1_name)
            .and_modify(|scr| {scr.goals_scored += team_1_score; scr.goals_conceded += team_2_score;} )
            .or_insert(TeamScores{goals_scored: team_1_score, goals_conceded: team_2_score});
        scores.entry(team_2_name)
            .and_modify(|scr| {scr.goals_scored += team_2_score; scr.goals_conceded += team_1_score;} )
